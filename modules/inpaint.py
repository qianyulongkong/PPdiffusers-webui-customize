...
def inpaint(model_name, lora_name, lora_style, init_image_mask, prompt, negative_prompt, num_images, sampler, Image_size, strength, guidance_scale, num_inference_steps, seed):
    ...
    # 输入图片及图片mask保存路径
    image_path=f"./PPdiffusers-webui/output/input_inpaint2img/img/tem_img_{lora_name}_{utils.out_put_num}.png"
    mask_path=f"./PPdiffusers-webui/output/input_inpaint2img/mask/tem_mask_{lora_name}_{utils.out_put_num}.png"
